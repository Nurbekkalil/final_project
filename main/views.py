...
from main.models import News, FavouriteNews, FavouriteLaws, Law, Publication
from main.serializers import NewsListSerializer, NewsItemSerializer, FavouriteLawsSerializer, LawsByTypeSerializer, \
...
class FavouriteLawsApiView(APIView):
    def get(self, request):
        ...
        data = FavouriteLawsSerializer(types, many=True).data
