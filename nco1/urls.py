...
urlpatterns = [
    ...
    path('api/v1/law_types/', views.FavouriteLawsApiView.as_view()),
    path('api/v1/laws/', views.LawsTypeApiView.as_view()),
    path('api/v1/laws/<int:pk>/', views.LawsItemApiView.as_view()),
